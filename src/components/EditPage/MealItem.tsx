...
const MealItem: React.FC<Props> = ({ meal }) => {
  ...
  return (
    <div
      ...
      className="pc:hover:scale-105 bg-primaryOrange rounded-md flex flex-row gap-5 items-center my-2 shadow-md  mobile:max-w-fit mobile:min-w-[80%] overflow-hidden pc:pr-4 pc:w-full pc:max-w-[300px]"
    >
