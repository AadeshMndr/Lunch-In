...
const MealItem: React.FC<Props> = ({ meal: { image, name, price, id } }) => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-1 gap-4 justify-between items-center rounded-md overflow-hidden p-0.5 pr-3 shadow-lg m-2 min-w-min bg-gradient-to-b from-primaryBrown from-95% to-[#ae896f]"
    >
